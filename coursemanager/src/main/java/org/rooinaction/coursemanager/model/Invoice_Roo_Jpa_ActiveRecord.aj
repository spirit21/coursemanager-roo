...
privileged aspect Invoice_Roo_Jpa_ActiveRecord {
    ...
    public static Invoice Invoice.findInvoice(Integer idinvoice) {
        if (idinvoice == null) return null;
        return entityManager().find(Invoice.class, idinvoice);
    }
    ...
    public void Invoice.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Invoice attached = Invoice.findInvoice(this.idinvoice);
