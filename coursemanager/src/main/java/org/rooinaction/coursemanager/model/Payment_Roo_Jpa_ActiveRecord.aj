...
privileged aspect Payment_Roo_Jpa_ActiveRecord {
    ...
    public static Payment Payment.findPayment(Integer idpayment) {
        if (idpayment == null) return null;
        return entityManager().find(Payment.class, idpayment);
    }
    ...
    public void Payment.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Payment attached = Payment.findPayment(this.idpayment);
